...
test('Log.error: should should be formatted correctly', () => {
...
test('Log.info: should should be formatted correctly', () => {
...
test('Log.done: should should be formatted correctly', () => {
	console.info = jest.fn();
